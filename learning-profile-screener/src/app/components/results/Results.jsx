...
import { exportProfileAsPDF } from '@/utils/exportProfilePDF'
...
export default function Results({ profile }) {
  return (
    <div className="space-y-8">
      ...
      <div
        id="profile-pdf"
        className="bg-[var(--bg-panel)] rounded-xl p-8 space-y-8"
      >
        {/* Header */}
      ...
      <div className="flex justify-center">
        <button
          onClick={() => exportProfileAsPDF('profile-pdf')}
          className="px-6 py-2 rounded-lg bg-[var(--accent-primary)] text-black font-semibold"
        >
          Download PDF
        </button>
      </div>
